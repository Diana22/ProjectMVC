...
5. Daca ramane timp, puteti sa incepeti sa faceti fiecare cate un model.
	Doar modelul deocamdata, ca sa testati puteti face un controller_test de exemplu. 
	Nu incepeti sa lucrati la controllere sau view-uri va rog
